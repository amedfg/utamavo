...
export default function JumbotronCV() {
  const whatsapp =
    "https://wa.me/6285693388888?text=Halo,%20Saya%20ingin%20bertanya%20tentang%20jasa%20CV%20+%20Virtual%20Office%20Anda?";

  return (
    <section
      id="cv-virtual-office"
    ...
    >
      <div className="hidden w-[619px] flex-col items-start justify-start lg:flex">
        <p className="text-5xl font-black text-primary">CV + Virtual Office</p>
