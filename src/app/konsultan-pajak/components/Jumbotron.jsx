...
export default function JumbotronPajak() {
  const whatsapp =
    "https://wa.me/6285693388888?text=Halo,%20Saya%20ingin%20bertanya%20tentang%20jasa%20Konsultan%20Pajak%20Anda?";
  ...
  return (
    ...
    >
      <div className="hidden w-[619px] flex-col items-start justify-start lg:flex">
        <p className="text-5xl font-black text-primary">Konsultan Pajak</p>
