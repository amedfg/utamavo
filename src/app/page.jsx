...
export default function Home() {
  ...
  return (
    <main className="w-full">
      ...
      <section id="jumbotron" className="px-8 lg:px-32 pt-36 w-screen flex">
        <div className="w-screen h-[450px] rounded-xl flex">
          ...
          <div className="w-full h-full bg-cover rounded-xl" style={{ backgroundImage: `url(${jumbotron})` }} >
            <div className="mt-10 ml-8 lg:mt-24 lg:ml-14 text-5xl font-black text-primary ">
            Utama Virtual Office
            </div>
            <div className="mt-6 ml-8 lg:ml-14 text-xl text-primary">
            Menyediakan kebutuhan Virtual Office anda dengan harga yang terjangkau.
            </div>
            <div className="pt-8 ml-8 lg:ml-14">
      ...
      <section id="layanan-kami" className="px-8 lg:px-32 pt-14">
        <h1 className="pb-6 text-secondary text-4xl font-bold">Layanan Kami</h1>
        <CarouselCard/>
      </section>
      <section id="about" className="px-8 lg:px-32 py-32">
        <div className="flex flex-row items-center">
          <div className="hidden lg:inline-flex items-center gap-2 min-w-[485px] min-h-[429px] relative w-full">
          ...
          <div className="w-screen h-[450px] rounded-xl hidden lg:flex">
              <div className="flex flex-col">
                <p className="text-3xl text-gold font-bold">UVO Selalu Memberikan Pelayanan yang Terbaik</p>
                <p className="pt-6 text-primary text-xl font-normal">Utama Virtual Office menawarkan layanan sewa kantor virtual dengan harga terjangkau, sebagai solusi alamat domisili hukum bagi bisnis Anda.</p>
                <div className="pt-6">
          ...
          <div className="lg:hidden w-screen h-[430px] rounded-xl flex">
            ...
            <div className="w-full h-full bg-cover bg-gradient-to-r from-background to-gold rounded-xl" style={{ backgroundImage: `url(${layanan})` }} >
              <div className="flex flex-col">
                <p className="mt-10 ml-4 text-3xl text-gold font-bold">UVO Selalu Memberikan Pelayanan yang Terbaik</p>
                <p className="mt-6 ml-4 pt-6 text-primary text-xl font-normal">Utama Virtual Office menawarkan layanan sewa kantor virtual dengan harga terjangkau, sebagai solusi alamat domisili hukum bagi bisnis Anda.</p>
      ...
      <section id="hubungi-kami" className="px-8 lg:px-32 pb-16 w-screen flex">
        <div className="w-screen h-[450px] rounded-xl flex">
            {/* Background Image */}
            <div className="w-full h-full bg-cover bg-left-bottom  rounded-xl" style={{ backgroundImage: `url(../img/hubungi-kami.png)` }} >
                <div className="mt-10 ml-8 lg:mt-24 lg:ml-14 text-4xl font-semibold text-gold">
                  Tertarik dengan Layanan Kami?
                </div>
                <div className="mt-6 ml-8 lg:ml-14 text-xl text-background lg:text-primary">
