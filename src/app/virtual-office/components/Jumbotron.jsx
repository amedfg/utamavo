  ...
  return (
    ...
    >
      <div className="hidden w-[619px] flex-col items-start justify-start lg:flex">
        <p className="text-5xl font-black text-primary">Virtual Office</p>
      ...
      <div className="flex w-screen lg:hidden">
        <div className="relative flex h-[450px] w-full overflow-hidden rounded-xl">
          ...
          <div className="relative z-10">
            <p className="ml-8 mt-32 text-3xl font-black text-primary">
              Virtual Office
            </p>
            <p className="ml-8 py-[23px] text-lg font-normal text-primary">
