...
export default function Footer() {
  return (
    <footer className="h-auto w-full px-8 py-8 text-primary lg:px-32">
      <div className="flex w-full flex-col justify-center gap-10 lg:flex-row lg:gap-[110px]">
        {/* Logo and Description */}
        <div className="mb-3 flex-1 lg:w-[411px]">
          <Image
        ...
        {/* Layanan Kami */}
        <div className="mb-3 flex-col-reverse">
          <h3 className="font-['Inter'] text-base font-bold text-gold">
            Layanan Kami
          </h3>
          <Link
            href="/virtual-office"
        ...
        {/* Hubungi Kami */}
        <div className="mb-3 flex-col-reverse items-end">
          <h3 className="font-['Inter'] text-base font-bold text-gold">
            Hubungi Kami
          </h3>
