    ...
    return (
      <footer className="w-full h-48 py-8 px-32 text-primary flex flex-row justify-between items-start gap-[110px]">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-[rgb(243,239,230)] text-base font-normal font-['Roboto']">
            Utama Virtual Office yang diakui oleh Pemerintah dan memenuhi syarat PKP. UVO menyediakan layanan Pendirian Badan Usaha (PT) dengan lokasi strategis.
          </p>
        </div>
        {/* Layanan Kami */}
        ...
        {/* Hubungi Kami */}
        <div className="flex flex-col">
          <h3 className="text-gold text-base font-bold whitespace-nowrap font-['Inter']">Hubungi Kami</h3>
          <div className="flex gap-2">
            ...
            <Link href={"#"} className="w-6 h-6 relative">
              {/* Mail */}
              <svg role="img" fill="#F3EFE6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Gmail</title><path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z"/></svg>
            </Link>
            <Link href={"#"} className="w-6 h-6 relative">
              {/* Instagram */}
