...
export default function JumbotronPT() {
  const whatsapp =
    "https://wa.me/6285693388888?text=Halo,%20Saya%20ingin%20bertanya%20tentang%20jasa%20PT%20+%20Virtual%20Office%20Anda?";
  ...
  return (
    ...
    >
      <div className="hidden w-[619px] flex-col items-start justify-start lg:flex">
        <p className="text-5xl font-black text-primary">PT + Virtual Office</p>
      ...
      <div className="flex w-screen lg:hidden">
        <div className="relative flex h-[450px] w-full rounded-xl">
          ...
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-background to-gold opacity-70"></div>
          {/* Content Overlay */}
          <div className="absolute z-10 flex h-full flex-col p-8">
            <p className="mt-8 text-3xl font-black text-primary">
              PT + Virtual Office
            </p>
            ...
            <Button
              asChild
              className="w-fit rounded-lg bg-gold px-2.5 py-2 text-base text-background"
            >
              <Link
                href={whatsapp}
                className="text-lg"
